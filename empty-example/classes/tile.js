...
//This is the code for the tile class, it handles everything that goes on with the destination of the words. specifically, location, looks and visual marking.
class tile {
  ...
  getCurrentAns() {
    ...
    while (i < words.length && found == 0) {
      if (words[i].overlapTile(i, this.spriteNum) == 1) {//if word overlapped with this tile
        this.currentAns = i;
        found = 1;
      };//default value is 20 and can be used to identify empty tile
      i++;
    };
