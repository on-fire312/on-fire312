//written by oscar
//this is he class that handels everything to do with the draggable words. their movement, coordinates, collision and marking.
class word {
  constructor(nX, nY, num, nText, nW, nH, nDetails) {
    //creates objects
  ...
  show() {
    ...
    stroke(255);
    textSize(40);
    text(this.text, (this.xMid), this.yTop + this.yHeight * 1 / 2 + 50 * 1 / 4);
